...
function make_shirt(size:number,text:string):any{
...
function make_shirt2(size:string="large",text:string="I LOVE TYPESCRIPT"):any{
       
      if(size==="medium"){console.log("I LOVE TYPESCRIPT")}
      else{console.log(`the size ${size} of the shirt with the label of "${text}" `)}
